...
> 中文版：[[wiki/zh/characters/character-arc|中文]]

## Definition

The finest writing not only reveals true character but **arcs** or changes that inner nature, for better or worse, over the course of the telling. A character arc is the transformation of the protagonist's deep character from one state to another through the cumulative pressure of the story's events.

## McKee's Argument

McKee traces a five-step pattern of character arc through the history of fiction:

1. **Characterization is laid out** — The protagonist's outer traits and persona are established.
2. **True character is revealed** — Choices under pressure expose the character's deep nature, often contrasting with the outer persona.
3. **Contrast deepens** — We sense hidden qualities beneath the surface, things the character doesn't yet know about himself.
...
- Confusing a change in circumstances with a change in character — getting a promotion isn't an arc
- Failing to earn the arc through sufficient escalating pressure
- Arcing characterization (new haircut, new attitude) rather than true character
- Neglecting the climax — if the last act fails, the arc fails
