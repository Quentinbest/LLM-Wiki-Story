...
flowchart TB
  ...
  pc[Progressive Complications]
  pnr[Points of No Return]
  law([Law of Conflict])
  comp[Complication vs Complexity]
  acts[[Act]]
  rhythm[Act Rhythm]
  subplot[[Subplot]]
  fe[False Ending]
  climax[[Story Climax]]
  ii --> pc
  pc -->|builds through| pnr
  law -.governs.-> pc
  comp -.classifies.-> pc
  pc --> acts
  acts --> rhythm
  subplot -.complicates.-> pc
  fe -.perturbs.-> rhythm
  acts --> climax
```
