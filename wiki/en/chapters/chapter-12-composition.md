...
```mermaid
flowchart TB
  uv[Unity and Variety]
  pace[Pacing]
  sym[Symbolic Ascension]
  trans[Principle of Transition]
  spine[Spine]
  climax[[Story Climax]]
  uv -->|binds| spine
  spine --> climax
  pace -->|modulates road to| climax
  sym -.intensifies meaning of.-> climax
  trans -->|links scenes within| pace
```
