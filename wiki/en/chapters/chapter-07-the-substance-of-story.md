---
title: "Chapter 7: The Substance of Story"
...
flowchart TB
  self[The Gap]
  prot[Protagonist]
  levels[Levels of Conflict]
  risk[Risk]
  action[Action vs Activity]
  insideout([Writing from the Inside Out])
  chinatown[Chinatown]
  prot -->|acts, provokes| self
  self -->|cracks across| levels
  self -->|demands| risk
  self -->|distinguishes| action
  insideout -.reveals.-> self
  chinatown -.dramatizes.-> self
```
